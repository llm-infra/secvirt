...
// NewParser creates a new JSON parser with default buffer size.
...
func (p *Parser) ParseMessage(data map[string]any) (Message, error) {
...
func (p *Parser) processJSONLineUnlocked(jsonLine string) (Message, error) {
...
func (p *Parser) parseUserMessage(data map[string]any) (*UserMessage, error) {
	...
	if content == nil {
		return nil, NewMessageParseError("user message missing content field", data)
	}
...
func (p *Parser) parseAssistantMessage(data map[string]any) (*AssistantMessage, error) {
	messageData, ok := data["message"].(map[string]any)
	if !ok {
	...
	var errorPtr *AssistantMessageError
	if errorStr, ok := messageData["error"].(string); ok {
		errType := AssistantMessageError(errorStr)
		errorPtr = &errType
	}
...
func (p *Parser) parseSystemMessage(data map[string]any) (*SystemMessage, error) {
...
func (p *Parser) parseResultMessage(data map[string]any) (*ResultMessage, error) {
...
func (p *Parser) parseContentBlock(blockData any) (ContentBlock, error) {
...
func (p *Parser) parseTextBlock(data map[string]any) (ContentBlock, error) {
...
func (p *Parser) parseThinkingBlock(data map[string]any) (ContentBlock, error) {
...
func (p *Parser) parseToolUseBlock(data map[string]any) (ContentBlock, error) {
...
func (p *Parser) parseToolResultBlock(data map[string]any) (ContentBlock, error) {
...
func (p *Parser) parseStreamEventMessage(data map[string]any) (*StreamEvent, error) {
	uuid, ok := data["uuid"].(string)
	if !ok {
		return nil, NewMessageParseError("stream_event missing uuid field", data)
	}

	sessionID, ok := data["session_id"].(string)
	if !ok {
		return nil, NewMessageParseError("stream_event missing session_id field", data)
	}

	event, ok := data["event"].(map[string]any)
	if !ok {
		return nil, NewMessageParseError("stream_event missing event field", data)
	}
